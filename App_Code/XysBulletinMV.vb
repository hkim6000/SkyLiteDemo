...
Public Class XysBulletinMV
    ...
    Private SQLGridInfo As New SQLGridSection.SQLGridInfo With { _
        ...
        .Query = New SQLGridSection.SQLQuery With {
            .Tables = "XysBulletin",
            .OrderBy = {"SYSDTE desc"}, _
            .Columns = {"BltnId", "BltnTitle", "BltnMemo", "CreatedBy", _
                    "dbo.XF_FileDownListEnc(FileRefId,'#') FileRefId", _
                    "dbo.XF_OffetTime(SYSDTE," + CSTimeOffset.ToString + ") SYSDTE"}, _
            .ColumnAlias = {Translator.Format("no"), _
                            Translator.Format("title"), _
                            Translator.Format("contents"), _
                            Translator.Format("publisher"), _
                            Translator.Format("attached"), _
    ...
    Public Overrides Function InitialModel() As ViewPart
        Return New ViewPart With {.Methods = ViewMethods("XysBulletin")}
    End Function
