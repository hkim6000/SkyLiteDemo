...
Public Class XysDictMV
    ...
    Private SQLGridInfo As New SQLGridSection.SQLGridInfo With { _
        ...
        .Query = New SQLGridSection.SQLQuery With {
            .Tables = "XysDict",
            .OrderBy = {"IsoCode", "Target", "KeyWord"}, _
            .Columns = {"Target", "IsoCode", "KeyWord", "Translated"}, _
            .ColumnAlias = {Translator.Format("target"),
                            Translator.Format("isocode"),
                            Translator.Format("keyword"),
                            Translator.Format("translated")}, _
    ...
    Public Overrides Function InitialModel() As ViewPart
        Return New ViewPart With {.Methods = ViewMethods("XysDict")}
    End Function
