...
Public Class XysLangMV
    ...
    Private SQLGridInfo As New SQLGridSection.SQLGridInfo With { _
        ...
        .Query = New SQLGridSection.SQLQuery With {
            .Tables = "XysOption",
            .OrderBy = {"CODE", "SNO"}, _
            .Columns = {"CODE", "SNO", "SD01", "SD02", "SD03"}, _
            .ColumnAlias = {Translator.Format("code"), _
                            Translator.Format("no."), _
                            Translator.Format("iso"), _
                            Translator.Format("locale"), _
                            Translator.Format("inuse")}, _
            .Filters = If(ParamValue("DataGrid_Filter") = String.Empty, "CODE=N'ISO639' and CODE+SD01+SD02+SD03+SD04+SD05+SD06+SD07 like '%%' ", ParamValue("DataGrid_Filter"))
        }
    }
    Public Overrides Function InitialModel() As ViewPart
        Return New ViewPart With {.Methods = ViewMethods("XysLang")}
    End Function
