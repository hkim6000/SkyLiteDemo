...
Public Class XysPageMV
    ...
    Private SQLGridInfo As New SQLGridSection.SQLGridInfo With { _
        ...
        .Query = New SQLGridSection.SQLQuery With {
            .Tables = "XysPage",
            .OrderBy = {"PageOrder", "PageName"}, _
            .Columns = {"PageId", "PageDesc + ' (<i>' + PageName + '</i>)' as PageName", "PageGroup", "PageOrder", "PageMenu", "PageUse"}, _
            .ColumnAlias = {"",
                            Translator.Format("page"),
                            Translator.Format("pagegroup"),
                            Translator.Format("pageorder"),
                            Translator.Format("pagemenu"),
                            Translator.Format("pageuse")}, _
    ...
    Public Overrides Function InitialModel() As ViewPart
        Return New ViewPart With {.Methods = ViewMethods("XysPage")}
    End Function
