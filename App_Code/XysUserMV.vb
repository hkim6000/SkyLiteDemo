...
Public Class XysUserMV
    ...
    Private SQLGridInfo As New SQLGridSection.SQLGridInfo With { _
        ...
        .Query = New SQLGridSection.SQLQuery With {
            ...
            .OrderBy = {"dbo.XF_RoleOrder(b.RoleId)", "b.UserName"}, _
            .Columns = {"a.UserId", "b.UserName", "dbo.XF_RoleAlias(b.RoleId) RoleAlias", "b.UserPhone", "b.UserEmail", "a.UserOTP", "a.UserStatus"}, _
            .ColumnAlias = {"",
                            ...
                            Translator.Format("userstatus")}, _
    ...
    Public Overrides Function InitialModel() As ViewPart
        Return New ViewPart With {.Methods = ViewMethods("XysUser")}
    End Function
